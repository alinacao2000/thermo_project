...
numberDensity = 0.1
kbt = 0.1
dt = 1.0E-3   # might need to change this
potential_kp_rmax_list  = [
    (6.25, 0.62, 3.337),
    (7.00, 0.50, 3.097),
    (7.25, 0.50, 3.034),
    (7.50, 0.53, 2.978),
...
# Parameters: define temperature and time steps
...
for k, phi, rmax in potential_kp_rmax_list:

    potential_k = k
    potential_phi = phi
    opp = hoomd.md.pair.OPP(cell, mode='shift')  # should we change the default_r_cut?
    opp.params[('A', 'A')] = {
        'C1': 1., 'C2': 1., 'eta1': 15,
    ...
    ndump = 1000
    steps = 1E8
    gsd_writer = hoomd.write.GSD(filename=f'/home/en540-tvo12/scratch/yicao/Thermo project_Yi/batch_results/batch_temp{kbt}_k{potential_k}_phi{potential_phi}_step_{steps}.gsd',
