...
for k, phi, rmax in potential_kp_rmax_list:
    ...
    ndump = 1000
    steps = 1E6
    gsd_writer = hoomd.write.GSD(filename=f'/home/en540-tvo12/scratch/yicao/Thermo project_Yi/test_results/test_k{potential_k}_phi{potential_phi}_step_{steps}.gsd',
